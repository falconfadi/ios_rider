...
var APP_UPDATE_URL_IOS = "http://www.google.com"; 
var APP_UPDATE_URL_ANDROID = "http://www.google.com"; 
        ...
        if(route_polyline != null){
            ...
            duration: 1000,
                ...
                route_distance_duration_info_marker = map.addMarker({
                    ...
                    'icon' : {url: 'img/1px.png', size:{width:4,height:4}},
                    'disableAutoPan':true,
                    'draggable' : false,
    ...
    if(multi_destinations['dest-1']['address']){
        if(markerds1){
            ...
            markerds1 = map.addMarker({
                ...
                'icon' : {url: 'img/waypoint.png', size:{width:64,height:64}},
                animation: plugin.google.maps.Animation.DROP
            });
...
function loadLang(){
    ...
    if(lang){
        ...
        selected_lang = {code:'en',name:'English',dir:'ltr'};
    }
